        ...
        <div id="middle-content">
          ...
          <div id="other-links">
            ...
            <div id="nx-cloud" class="rounded shadow">
              ...
              <a href="https://cloud.nx.app/connect/iiuO9v7gEc" target="_blank" rel="noreferrer">Click here to finish</a>
            </div>
          </div>
        </div>
        <!--  COMMANDS  -->
...
nx run-many -t build test lint</pre>
          ...
          <details>
            ...
            <pre>nx show project crm-dashboard</pre>
          </details>
